...
def ShowScore(win, score):
    ...
    while run:
        ...
        display_msg = "You ded\nScore: "+str(score)
        text = font.render(display_msg, True, (255, 255, 255))
        #win.blit(text, [WIN_WIDTH / 2 - text.get_rect().width/2, WIN_HEIGHT / 2 - text.get_rect().height/2])
        blitlines(win, display_msg, font, (255, 255, 255), WIN_WIDTH / 2 - text.get_rect().width / 4, WIN_HEIGHT / 2 - text.get_rect().height/2)
        pygame.display.update()
